    ...
    <DStack :breakpoint="Breakpoint._2_M" vSpacing="1.0rem" hSpacing="1.0rem">
      ...
      <VStack id="text06" spacing="0.5rem">
        <p>
          ...
          for a few different companies over the years;
          and while I like my current position,
          I'd also like to apply my expertise to independently
          <span class="highlight">creating</span> practical software and websites.
          
        </p>
        <p>
          I got into programming via an old game called
          <span class="italicized highlight">Creatures</span>.
          I wanted to add something to the game, so I followed some tutorials
          on how to make a basic mod.
        </p>
        <p>
          <img :src="chuOld" style="float: left; height: 2.5rem;" class="inline-img"/>
          Eventually I released a small script as a mod.
          <img :src="chuNew" style="float: right; height: 3.5rem;" class="inline-img"/>
          The script took the simple list of past life events and added more info and even photos.
        </p>
      </VStack>
    </DStack>
  </DStack>
